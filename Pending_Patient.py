...
class PendingPatient:
    def data(self):
        ...
        gender = Label(self.root,text=data1[0][5], font=("Arial", 16), bg="white", fg="black").place(x=650, y=160, width=240, height=30)
    ...
    def __init__(self, root):
        ...
        title = Label(self.root, text="Pending Patient", font=("ALGERIAN", 40, "bold"), bg="blue", fg="white", padx=20).place(x=0, y=0, relwidth=1, height=70)
        ...
        gender = Entry(self.root, font=("Arial", 16), bg="white", fg="black").place(x=650, y=160, width=240, height=30)
        ...
        #Check_In = Label(self.root, text="Check In :", font=("Arial", 16), bg="blue", fg="white").place(x=100, y=320, width=100)
        #Check_Inentry = Entry(self.root, font=("Arial", 16), bg="white", fg="black").place(x=220, y=320)
        ...
        #Check_Out = Label(self.root, text="Check Out :", font=("Arial", 16), bg="blue", fg="white").place(x=500, y=320, width=140)
        #Check_Outentry = Entry(self.root, font=("Arial", 16), bg="white", fg="black").place(x=650, y=320, width=240, height=30)
